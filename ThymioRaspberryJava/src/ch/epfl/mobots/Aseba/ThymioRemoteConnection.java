...
public class ThymioRemoteConnection {
	...
	// TODO:
	//thymio node id in the aseba network (remapping ids may be needed, to check when MRS are considered)
	 ...
	 * on the ground. Three arrays hold the values of three sensors. 
	 * Thymio updates this array at a frequency of 10 Hz.
	 * 
	 */
	 ...
	 * 
	 * @return Ground Ambient Light value, the index 0 corresponds to the left sensor and the index 1 to the right
	 * sensor.
	 */
	 ...
	 * reflected light)
	 * 
	 * @return Ground Reflected Light value, the index 0 corresponds to the left sensor and the index 1 to the right
	 * sensor.
	 */
	 ...
	 * light, linked to the distance and to the ground colour.
	 * 
	 * @return Ground Delta value, the index 0 corresponds to the left sensor and the index 1 to the right
	 * sensor.
	 */
